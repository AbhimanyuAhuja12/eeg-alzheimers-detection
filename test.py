...
# Fixed precision calculations (avoid division by zero)
...
specificity_a = (correct_c + correct_f) / (correct_c + correct_f + a_as_c + a_as_f) if (correct_c + correct_f + a_as_c + a_as_f) > 0 else 0
...
specificity_c = (correct_a + correct_f) / (correct_a + correct_f + c_as_a + c_as_f) if (correct_a + correct_f + c_as_a + c_as_f) > 0 else 0
...
specificity_f = (correct_a + correct_c) / (correct_a + correct_c + f_as_a + f_as_c) if (correct_a + correct_c + f_as_a + f_as_c) > 0 else 0
...
fpr_a, tpr_a, _ = roc_curve((all_labels == 0).astype(int), all_probs[:, 0])
fpr_c, tpr_c, _ = roc_curve((all_labels == 1).astype(int), all_probs[:, 1])
fpr_f, tpr_f, _ = roc_curve((all_labels == 2).astype(int), all_probs[:, 2])

roc_auc_a = roc_auc_score((all_labels == 0).astype(int), all_probs[:, 0])
roc_auc_c = roc_auc_score((all_labels == 1).astype(int), all_probs[:, 1])
roc_auc_f = roc_auc_score((all_labels == 2).astype(int), all_probs[:, 2])
